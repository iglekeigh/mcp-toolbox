...
func (t Tool) EmbedParams(ctx context.Context, _ tools.SourceProvider, params parameters.ParamValues, models map[string]embeddingmodels.EmbeddingModel) (parameters.ParamValues, error) {
	return params, nil
}
